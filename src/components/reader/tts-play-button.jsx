...
export default function TtsPlayButton({ sentences, chapterIndex }) {
  ...
  const { isPlaying, isPaused, preparing, modelLoading, modelProgress } = useTtsStore();

  const handleClick = async () => {
    if (modelLoading || preparing) return;
  ...
  // Loading state (model loading or preparing first sentences)
  if (modelLoading || preparing) {
    return (
      <button

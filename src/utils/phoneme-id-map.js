// Auto-extracted from model/nh.onnx.json
// Maps espeak-ng phoneme characters to integer IDs for the nh.onnx Piper TTS model
// Special tokens: _ = pad(0), ^ = BOS(1), $ = EOS(2), ' ' = space(3)
export const PHONEME_ID_MAP = {
  ...
  "↓": [148], "#": [149], "\"": [150], "↑": [151], "\u033A": [152],
  "\u033B": [153], "g": [154], "ʦ": [155], "X": [156], "\u031D": [157],
  "\u030A": [158], "ɝ": [159], "ʷ": [160],
};

// Special token IDs
export const PAD_ID = 0n;
export const BOS_ID = 1n;  // ^ beginning of sentence
export const EOS_ID = 2n;  // $ end of sentence
export const SPACE_ID = 3n; // space between words

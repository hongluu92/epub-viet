...
self.addEventListener("message", (event) => {
  ...
  if (data?.kind === "phonemize") {
    self.postMessage({
      kind: "debug",
      message: "Received phonemize request",
      meta: {
        modelConfigUrl: data.modelConfigUrl,
        piperPhonemizeJsUrl: data.piperPhonemizeJsUrl,
        piperPhonemizeWasmUrl: data.piperPhonemizeWasmUrl,
        piperPhonemizeDataUrl: data.piperPhonemizeDataUrl,
      },
    });
  }
...
async function init(data, phonemizeOnly = false) {
  ...
  self.postMessage({
    kind: "debug",
    message: "Loaded model config",
    meta: {
      voice: modelConfig?.espeak?.voice,
